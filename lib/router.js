...
Router.map(function() {
  ...
  this.route('fourzerofour', {path: '/404.html'});
  this.route('fivezerozero', {path: '/500.html'});
  ...
  this.route('css_animation', {path: '/css_animation.html'});
  ...
  this.route('lockscreen', {path: '/lockscreen.html'});
  ...
  this.route('register', {path: '/register.html'});
